...
public abstract class AbstractWsController {
	...
	protected void onOpen(Session session, EndpointConfig config) {
		...
		broadcast2All(new Message(getUserName(), Message.MsgConstant.OPEN, getUsers()).toString());
	...
	protected void onClose() {
		...
		broadcast2Others(new Message(getUserName(), Message.MsgConstant.CLOSE, getUsers()).toString());
